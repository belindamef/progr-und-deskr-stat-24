...
\textbf{18.10.23}       & \textbf{R Grundlagen}          & (2) \textbf{R und Visual Studio Code}                      \\
...
```
Der Workspcae / (globale) Arbeitsbereich
...
\color{red} TODO: neuen Screenshot einfügen

In VSCode kann der Workspace in the R Extension pane angezeigt werden
\vfill
![](../Abbildungen/pds_2_workspace_vsc.png){width="70%"}
