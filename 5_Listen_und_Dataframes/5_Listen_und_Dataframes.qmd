...
L2[[2]](1)                     # Anwendung des 2. Listenelementinhalts auf den 1. Listenelementinhalt -> exp(1)
```
...
![](../Abbildungen/pds_5_view.pdf){width="25%"}
...
\subsection{Indizierung}
# Indizierung
\textcolor{darkblue}{Mit einem Index}
\small
...
# Indizierung
\setstretch{1.2}
\textcolor{darkblue}{Mit zwei Indices}
