...
* 11:00 - 12:00 Uhr: Leistungsnachweis ((Teil 1)
  * Teilnahme am Leistungsnachweis über Moodle (Einschreibung erfolgt automatisch für alle die im [\textcolor{linkblue}{Moodle-Kurs}](https://elearning.ovgu.de/course/view.php?id=15163) eingeschrieben sind)
...
\item Schreiben Sie ein einfaches Skript, in welchem Daten eingelesen und geschrieben
\end{enumerate}
