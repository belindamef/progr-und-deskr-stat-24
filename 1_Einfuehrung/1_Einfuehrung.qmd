...
# Gliederung - Grundbegriffe der Informatik {.plain}
\large
\vfill
\setstretch{2.5}
...
# Selbstkontrollfragen - Grundbegriffe der Informatik
\setstretch{2}
\small
...
# Gliederung - R ud Visual Studio Code {.plain}
\large
\vfill
\setstretch{2.5}
