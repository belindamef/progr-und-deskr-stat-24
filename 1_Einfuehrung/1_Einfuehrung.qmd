...
# Zentraleinheit eines Computers (Hauptplatine, Motherboard, Mainboard)
\vfill
...
\vfill
![](../Abbildungen/migl_7_von_neumann_firstdraft.jpg){width="30%"}
...
![](../Abbildungen/migl_7_programmiersprache.pdf){width="50%"}
