...
\small
\textcolor{darkblue}{(1) Anwendungsszenario und (2) Statistisches Inferenzmodell}
...
\footnotesize
\textcolor{darkcyan}{Was ist der "Testgegenstand"?}
...
\footnotesize
\textcolor{darkcyan}{Wie kann ich die Wahrscheinlichkeit dafür, dass der Test den Wert 1 ergibt, obwohl der Nullhypothesenparameterwert "wahr" wäre (Typ-I Fehler) kontrollieren?}
...
\tiny
```{r, eval = T}
#| label: Manueller Zweistichproben-T-Test
# Datenauswahl
y_1       <- D$Delta.BDI[D$Bedingung == "Klassisch"]                         # \Delta.BDI Daten Klassische Therapie
y_2       <- D$Delta.BDI[D$Bedingung == "Online"]                            # \Delta.BDI Daten Klassische Therapie
...
\tiny
```{r, eval = T}
#| label: Automatischer Zweistichproben-T-Test
...
* \tiny Es wurden die Daten verwendet, die in den Variablen `x_1` und `x_2` gespeichert sind. 
* Der Wert der T-Teststatistik $T$ ist $2.65$
...
\item Was sind die zugrundeliegenden Modellannahmen im Rahmen der Frequentistischen Inferenz?
