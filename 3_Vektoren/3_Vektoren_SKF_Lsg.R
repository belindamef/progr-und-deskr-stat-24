...
s = sum(x)				   # Summation in integer gewandelter logical Elemente (implicit coercion)
...
# Anmerkung: die Zeile drüber ist auskommentiert. Um den Fehler zu reproduzieren, 
# einfach den hashtag entfernen
...
x == NA					      # Kein Testen auf NAs : 5 == NA ist NA, nicht FALSE
                      # hier sollt eine Warnung angezeigt werden
...
# Kreiere einen neuen Vektor, der nur die letzten 10 Elemente des Vektors enthält
vektor_letzte_10 = vektor[indizes_letzte_10]
